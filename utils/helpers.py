...
def init_args():
    ...
    parser.add_argument('--forget_image_path', type=str, default='test/mma_forget_data')
    parser.add_argument('--retain_image_path', type=str, default='test/mma_retain_data')
